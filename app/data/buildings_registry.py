...
BUILDING_REGISTRY: List[Dict[str, Any]] = [
    {
        ...
        "floors": 163,
        "area_sqm": 309473.0,
        "site_profile": "building_with_industrial_cooling",
    ...
    {
        "id": "difc-gate-01",
        "name": "DIFC Cold Storage Plant",
        "location": "DIFC, Dubai, UAE",
        "floors": 15,
        "area_sqm": 45000.0,
        "site_profile": "industrial_cooling_only",
        "bms_type": "Modbus / BACnet",
        "installed_capacity_kw": 1200.0,
        "metasys_objects": {},
        "refrigeration_objects": {},
        "refrigeration_connection": {"source": "modbus", "host": "192.168.1.102", "port": 502, "poll_interval_seconds": 60},
        "bacnet_points": [],
        "modbus_registers": [],
    },
]
